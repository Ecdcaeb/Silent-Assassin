...
import static com.Hileb.moremomostories.util.NBTStrDef.IDLNBTDef.STATE;
import static com.Hileb.moremomostories.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.Hileb.moremomostories.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "moremomostories.msg.being_targeted";
