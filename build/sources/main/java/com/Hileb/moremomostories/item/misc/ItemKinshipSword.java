...
import com.Hileb.moremomostories.item.IGuaEnhance;
import com.Hileb.moremomostories.item.ItemSwordBase;
import com.Hileb.moremomostories.util.IDLGeneral;
...
//    public com.Hileb.moremomostories.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.Hileb.moremomostories.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.Hileb.moremomostories.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.Hileb.moremomostories.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
