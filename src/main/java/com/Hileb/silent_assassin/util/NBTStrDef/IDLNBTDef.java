package com.Hileb.silent_assassin.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "silent_assassin.shared.off";
	public static final String NAME_ON= "silent_assassin.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "silent_assassin.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "silent_assassin.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "silent_assassin.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "silent_assassin.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "silent_assassin.kill_count.desc";
