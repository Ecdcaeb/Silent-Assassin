...
import com.Hileb.silent_assassin.util.CommonFunctions;
import com.Hileb.silent_assassin.util.Teleport;
...
public class CommandDimTeleport extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        }catch (NumberFormatException e)
        {
            ...
            {
                CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP) sender, "silent_assassin.msg.dim_id_invalid", TextFormatting.RED, s);
            }
            return;
        }
